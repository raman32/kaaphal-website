...
const Profile = (): JSX.Element => {
    ...
    return (
        <div className="w-full ">
            ...
            <div ref={numberAnimatorRef} className="flex flex-row flex-wrap justify-around bg-gray-200 text-black px-4 py-4 ">
            ...
            <div className={clsx(store.isDark ? "bg-gray-900" : "bg-white", "py-4 px-4 sm:px-8  ")}>
