    ...
    return (
        <div className="w-full px-4 sm:px-8" role="application">
            ...
            <div className="flex flex-row flex-wrap ">
                {categories ? categories.map((category, index) => index < 11 ? <Link href="/loksewa/mcq/[loksewaCategoryId]" as={'/loksewa/mcq/' + category.id} ><div key={category.id} className="shadow hover:shadow-lg px-8 py-4 my-2 mx-4 w-80 cursor-pointer bg-white">
